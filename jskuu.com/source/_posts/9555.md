---
title: PropTypes 进行类型检查
---

转自： https://www.cnblogs.com/cangqinglang/p/9077904.html

从 React v15.5 开始 ，React.PropTypes 助手函数已被弃用，建议使用 prop-types 库 来定义contextTypes。
...
class ListView extends Component {
  static propTypes = {
    pullUpLoad: PropTypes.bool,//是否显示上拉加载
